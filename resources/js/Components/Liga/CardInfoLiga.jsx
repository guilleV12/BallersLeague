  ...
  return (
                <div className="w-full flex justify-center overflow-x-auto shadow-lg shadow-gray-500 rounded-lg border border-gray-400">
                        <table className="w-full flex-col text-left text-black dark:text-gray-400">
                                <caption className='bg-orange-500 text-white text-2xl font-semibold py-5'>Informacion de liga</caption>
                                <tbody>
                                    <tr className="grid md:flex bg-gray-50 border-b dark:bg-gray-900 dark:border-gray-700">
                                            <th scope="row" className="text-base md:w-[50%] px-6 py-1 lg:py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                Nombre:
                                            </th>
                                            <td className="px-6 py-1 lg:py-3 text-sm text-right md:text-left md:w-[50%]">
                                                {liga.nombre}.
                                            </td>  
                                    </tr>
