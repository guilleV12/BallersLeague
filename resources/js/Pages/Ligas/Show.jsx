...
const Show = ({ patrocinadores, campeon, partidosPlayoffs, fechasPlayoffs, playoffs, cantNotiUser, auth, user, liga, equipos, userAdmin, arbitros, users, miLiga, calendario, fechas, jugadores, partidos, jugadorPartido, rol, notificacionesUsuario, notificaciones }) => {
  return (
